    ...
    >
        <div class="py-1">
            ...
            <button
                wire:click="logout"
                type="button"
                class="flex items-center gap-3 w-full px-4 py-2.5 text-sm text-destructive hover:text-destructive/90 hover:bg-card-hover transition-colors cursor-pointer"
            >
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
