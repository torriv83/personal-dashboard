                ...
                >
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            ...
                            @endphp
                            <div class="flex items-center justify-center w-16 h-16 rounded-lg {{ $bgColor }}">
                                @switch($iconType)
                                    @case('clearsky')
                                        {{-- Sun --}}
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <button
                                ...
                                class="p-2 text-muted-foreground hover:text-accent transition-colors cursor-pointer disabled:opacity-50"
