            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-border">
                    @forelse($this->shifts as $shift)
                        <tr class="hover:bg-card-hover transition-colors {{ $shift->is_archived ? 'opacity-50' : '' }} {{ $shift->is_unavailable ? 'bg-warning/5' : '' }}">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex justify-center">
                                    <button wire:click="toggleField({{ $shift->id }}, 'archived')" class="inline-flex cursor-pointer" title="Toggle arkivert">
